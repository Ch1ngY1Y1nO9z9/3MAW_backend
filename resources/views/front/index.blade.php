            ...
            <div class="container px-5 md:py-24 py-10 mx-auto flex flex-wrap">
                <div class="flex flex-wrap w-full">
                    <div class="lg:w-1/3 md:w-1/2 object-cover object-center rounded-lg">
                        <div class="flex flex-wrap w-full mb-10">
                            <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                                <h1 class="sm:text-3xl text-2xl font-bold title-font mb-2 text-custom-purple">About 3 Maw
                                </h1>
                    ...
                    <div class="lg:w-2/3 md:w-1/2 md:pl-10 md:py-6 font-bold text-black leading-loose md:pt-0 pt-10">
                        ...
                        <p class="tracking-wide md:text-justify md:text-lg">
                            A specialized rubber-part manufacturer with advanced facilities and integrated production from
                            R&D, manufacture to delivery, we supply a wide array of automotive, hardware,electronic,
                            mechanical and healthcare equipment parts and accessories.<br>
                            We prioritize :<br>
                            1. reliability<br>
                            2. quality<br>
                            3. innovation<br>
            ...
            <div class="container px-5 pt-20 pb-20 mx-auto text-white">
                ...
                <div class="flex flex-wrap -m-2">
                    <div class="p-2 lg:w-1/4 md:w-1/2 w-full text-white">
                        <div class="h-full text-center p-4 rounded-lg transform duration-300 hover:scale-105">
                            <img class="rounded-full object-cover object-center inline-block w-64 h-64"
                                src="/img/applications/Automotive.jpg" alt="Automotive">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/4 md:w-1/2 w-full text-white">
                        <div class="h-full text-center p-4 rounded-lg transform duration-300 hover:scale-105">
                            <img class="rounded-full object-cover object-center inline-block w-64 h-64"
                                src="/img/applications/Aerospace.jpg" alt="Aerospace">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/4 md:w-1/2 w-full text-white">
                        <div class="h-full text-center p-4 rounded-lg transform duration-300 hover:scale-105">
                            <img class="rounded-full object-cover object-center inline-block w-64 h-64"
                                src="/img/applications/Oil&gas industry.jpg" alt="Oil&gas industry">
                            <div class="flex-grow">
                    ...
                    <div class="p-2 lg:w-1/4 md:w-1/2 w-full text-white">
                        <div class="h-full text-center p-4 rounded-lg transform duration-300 hover:scale-105">
                            <img class="rounded-full object-cover object-center inline-block w-64 h-64"
                                src="/img/applications/Water&food industry.jpg" alt="Water&food industry">
                            <div class="flex-grow">
